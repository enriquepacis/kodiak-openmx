...
#+begin_src sh :eval never :tangle ../environment.yml
  dependencies:
    - python=3.12
    - numpy
    - scipy
...
#+begin_src python :results output :tangle ../src/kodiak_openmx/__init__.py
  __version__ = "0.1.0"

  from .openmx_tools import *
  from .pbs_tools import *
#+end_src
* GitHub                                                       :noexport:
